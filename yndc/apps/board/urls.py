...
urlpatterns = patterns('board.views',
    ...
    url(r'^property/(?P<house_slug>[\w-]+)/unarchive/?$', 'unarchive_house', name='unarchive_house'),
    ...
    url(r'^property/(?P<house_slug>[\w-]+)/boards/(?P<board_id>\d+)/edit/?$', 'edit_board', name='edit_board'),
